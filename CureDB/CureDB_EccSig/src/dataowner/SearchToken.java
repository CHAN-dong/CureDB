...
public class SearchToken {
    ...
    public SearchToken(TokenNode tokenNode, List<List<String>> tau_w_list, List<List<String>> delta_w_list, int type) {
    ...
    public String toString() {
        ...
        str.append("\n");
//        for (String tau_w : tau_w_list) str.append(tau_w).append(";");
//        str.append("\n");
//        for (String delta_w : delta_w_list) str.append(delta_w).append(";");
        return str.toString();
    }
}
